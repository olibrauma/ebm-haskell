...
👉 [**ebm-haskell/**](file:///home/takeru/git/EBM-on-Mars/ebm-haskell/)
...
- `test.c`: レガシーなモノリスC実装
- `ebm-c-refactored/`: 構造化・モジュール化済みC実装（Ground Truth）
- `ebm-haskell/`: **メインのHaskellソースコード**
- `data/golden-master/`: 移植検証に使用した高精度な正解データ（Golden Master）
- `scripts/`: 検証・生成用スクリプト群
